...
![Header](https://capsule-render.vercel.app/api?type=waving&color=gradient&customColorList=6,11,20,24,30&height=200&section=header&text=Luana%20Alencar&fontSize=60&fontColor=fff&animation=twinkling&fontAlignY=35&desc=Technology%20Student&descSize=20&descAlignY=55)
...
<p align="center">
  <picture>
    ...
    <source media="(prefers-color-scheme: light)" srcset="https://raw.githubusercontent.com/LuAllencar/LuAllencar/output/github-contribution-grid-snake.svg">
    <img alt="snake animation" src="https://raw.githubusercontent.com/LuAllencar/LuAllencar/output/github-contribution-grid-snake.svg">
  </picture>
</p>
...
🏆 **Destaque:** 3º lugar no **FIRST LEGO League** – Projeto de Inovação  
🎮 **TCC:** Jogo Educativo 3D com Unreal Engine *(em planejamento)*
...
### 📊 Dashboard Agrícola
Dashboard interativo para **análise de produtividade agrícola**, unindo dados de VANT, Excel e Power BI para decisões estratégicas.  
📊 **Stack:** Power BI • Excel • AutoCAD  

---

### 🎮 Jogo Educativo 3D *(TCC em andamento)*
Jogo educativo 3D imersivo com dublagem e multiplayer, desenvolvido com **Unreal Engine** e **Blueprints**.  
🎮 **Stack:** Unreal Engine • Blueprint • Design 3D  
